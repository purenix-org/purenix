final: prev: {
  ...
  purenix =
    final.haskell.lib.compose.justStaticExecutables final.haskell.packages.ghc8107.purenix;

  hacking-on-purenix-shell = final.haskell.packages.ghc8107.shellFor {
    withHoogle = true;
